...
urlpatterns = [
    ...
    path("plans/<uuid:plan_id>/mark-printed/", views.plan_mark_printed, name="plan_mark_printed"),
    path("plans/<uuid:plan_id>/clear-printed/", views.plan_clear_printed, name="plan_clear_printed"),
    ...
    path("recipes/<uuid:recipe_id>/clear-veto/", views.recipe_clear_vetoed, name="recipe_clear_vetoed"),
    path("recipes/<uuid:recipe_id>/veto-today/", views.recipe_veto_today, name="recipe_veto_today"),
